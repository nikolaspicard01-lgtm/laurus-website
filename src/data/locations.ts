...
export const summerLocations: Location[] = [
  // West Island
  {
    ...
    holidayNote: "Open on June 24th (Saint-Jean-Baptiste) and July 1st (Canada Day) — no interruption to your child's camp week.",
    extendedCare: "Included", lunchAvailable: true, lat: 45.4942, lng: -73.8125,
  },
  {
    slug: "beaconsfield", name: "Beaconsfield", region: "West Island",
    venue: "Windermere Park / Sherbrooke Senior Academy", address: "Beaconsfield, Quebec H9W 1V8",
    dates: "Jun 22 – Aug 21", regularPrice: "$375/wk", earlyBirdPrice: "$345/wk",
  ...
  },
  {
    ...
    dates: "Jun 25 – Aug 7", regularPrice: "$375/wk", earlyBirdPrice: "$345/wk",
  ...
  {
    slug: "dorval", name: "Dorval", region: "West Island",
    venue: "Collège Sainte-Anne | Secondaire Dorval", address: "100 Boul. Bouchard, Dorval, QC H9S 1A7",
    dates: "TBD", regularPrice: "$375/wk", earlyBirdPrice: "$345/wk",
    notes: "Coming soon — details being confirmed",
    registrationUrl: "https://app.amilia.com/store/en/laurus-summer-camp/api/Program/Detail?programId=b8w23Nk",
    hours: "TBD", totalWeeks: "TBD",
    highlights: ["Premium Collège Sainte-Anne campus", "Modern secondary school facilities", "Close to Dorval train station", "Easy access from Highway 20"],
    nearbyLandmarks: "On Boulevard Bouchard in Dorval, near Pine Beach and the Dorval train station. Easy access from Highway 20 and the Dorval Circle.",
    extendedCare: "TBD", lunchAvailable: true, lat: 45.4500, lng: -73.7500,
  },
  // Montreal
  {
    ...
    dates: "Jun 22 – Aug 14", regularPrice: "$375/wk", earlyBirdPrice: "$345/wk",
  ...
  },
  {
    ...
    venue: "Willingdon Elementary (Junior EMSB)", address: "5870 Rue de Terrebonne, Montréal, QC H4A 1B5",
    dates: "Jun 22 – Aug 21", regularPrice: "$375/wk", earlyBirdPrice: "$345/wk",
  ...
  },
  {
    ...
    venue: "East Hill Elementary School (EMSB)", address: "10350 Bd Perras, Montréal, QC H1C 2H1",
    dates: "Jun 22 – Aug 21", regularPrice: "$375/wk", earlyBirdPrice: "$345/wk",
  ...
  {
    slug: "pierrefonds", name: "Pierrefonds", region: "Montreal",
    dates: "TBD", regularPrice: "$375/wk", earlyBirdPrice: "$345/wk",
    notes: "Coming soon — details being confirmed",
    registrationUrl: "https://app.amilia.com/store/en/laurus-summer-camp/shop/programs",
    hours: "TBD", totalWeeks: "TBD",
    highlights: ["West Island convenience", "Family-friendly Pierrefonds community", "Close to Cap-Saint-Jacques nature park", "Easy access from A-40"],
    nearbyLandmarks: "In the family-friendly borough of Pierrefonds-Roxboro, near Cap-Saint-Jacques Nature Park and Pierrefonds Cultural Centre.",
    extendedCare: "TBD", lunchAvailable: true, lat: 45.4900, lng: -73.8300,
  },
  // Off Island
  {
  ...
  {
    slug: "laval-2", name: "Laval 2", region: "Off Island",
    dates: "TBD", regularPrice: "$365/wk", earlyBirdPrice: "$325/wk",
    notes: "Coming soon — second Laval location being confirmed",
    registrationUrl: "https://app.amilia.com/store/en/laurus-summer-camp/api/Program/Detail?programId=xW5GEWb",
    hours: "TBD", totalWeeks: "TBD",
    highlights: ["Second Laval location for growing demand", "Off-island pricing", "More options for Laval families", "Details coming soon"],
    nearbyLandmarks: "Second location in Laval — venue and address to be confirmed.",
    extendedCare: "TBD", lunchAvailable: true, lat: 45.5700, lng: -73.7200,
  },
  {
    slug: "rosemere", name: "Rosemère", region: "Off Island",
    venue: "McCaig Elementary", address: "501 Northcote St, Rosemère, Quebec J7A 1Y1",
    dates: "Jun 29 – Aug 14", regularPrice: "$365/wk", earlyBirdPrice: "$325/wk",
  ...
  },
  {
    ...
    holidayNote: "OPEN June 24th and July 1st — no interruption to your child's camp week.",
    extendedCare: "Included", lunchAvailable: true, lat: 45.4580, lng: -73.4580,
  },
  {
    slug: "vaudreuil", name: "Vaudreuil", region: "Off Island",
    dates: "Jun 22 – Aug 21", regularPrice: "$365/wk", earlyBirdPrice: "$325/wk",
    notes: "OPEN June 24th and July 1st. Venue being confirmed.",
  ...
  },
  {
    ...
    venue: "Roberta Bondar / St. Timothy's Presbyterian Church", address: "159 Lorry Greenberg Dr, Ottawa, ON K1T 3J6",
    ...
    hours: "7:30 AM – 5:30 PM", totalWeeks: "3–8 (+ Week 9)",
    ...
    holidayNote: "Starts July 6th. Week 9 (Aug 17–21) at St. Timothy's Presbyterian Church, 2400 Alta Vista Dr.",
